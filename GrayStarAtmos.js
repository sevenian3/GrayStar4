...
// Fe I: Z=26 --> iZ=25
         ...
         species = "CI";
         logUC1 = getPartFn(species);
         species = "MgI";
         logUMg1 = getPartFn(species);
         species = "MgII";
         logUMg2 = getPartFn(species);
         species = "AlI";
         logUAl1 = getPartFn(species);
         species = "SiI";
         logUSi1 = getPartFn(species);
         species = "SiII";
         logUSi2 = getPartFn(species);
         species = "FeI";
         logUFe1 = getPartFn(species);
...
//         modcount = modelnum
         for (var i = 0; i < numDeps; i++){
            thelp = Math.floor(temp[0][i]/1000.0);
...
//         modcount = modelnum
         for (var i = 0; i < numDeps; i++){
            thelp = Math.floor(temp[0][i]/2000.0);
            // -1 term to adjust from FORTRAN to Java subscripting
...
// He I: Z=2 --> iZ=1:
         ...
         species = "HI";
         logUH1 = getPartFn(species);
         species = "HeI";
         logUHe1 = getPartFn(species);
